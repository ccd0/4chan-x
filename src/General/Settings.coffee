Settings =
  ...
  advanced: (section) ->
    ...
    $('.warning[data-feature="Unread Favicon"]').hidden = false unless Conf['Track Read Posts']
  ...
  favicon: ->
    Favicon.switch()
    Unread.update() if g.VIEW is 'thread' and Conf['Track Read Posts'] and Conf['Unread Favicon']
