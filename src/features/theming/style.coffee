...
"
  ...
  layout: ->
    ...
    css = """<%= grunt.file.read('src/css/layout.css') %>"""
  ...
  theme: (theme) ->
    ...
    css = """<%= grunt.file.read('src/css/theme.css') %>"""

    <%= grunt.file.read('src/css/themeoptions.css') %>
    
    css

  iconPositions: ->
    css = """<%= grunt.file.read('src/css/icons.base.css') %>"""
    i = 0
    ...
    if _conf["Icon Orientation"] is "horizontal"
      ...
      css += """<%= grunt.file.read('src/css/icons.horz.css') %>"""

      if _conf["Updater Position"] isnt 'moveable'
        css += """<%= grunt.file.read('src/css/icons.horz.tu.css') %>"""
    else
      ...
      css += """<%= grunt.file.read('src/css/icons.vert.css') %>"""

      if _conf["Updater Position"] isnt 'moveable'
        css += """<%= grunt.file.read('src/css/icons.vert.tu.css') %>"""
