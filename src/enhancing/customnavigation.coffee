...
Navigation =
  ...
  links: [
    ...
    ["vr", "Retro Games", "//boards.4chan.org/vr/"]
    ...
    ["gd", "Graphic Design", "//boards.4chan.org/gd/"]
    ...
    ["out", "Outdoors", "//boards.4chan.org/out/"]
