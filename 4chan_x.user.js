...
(function() {
  ...
  UI = (function() {
    ...
    Menu = (function() {
      ...
      Menu.prototype.open = function(button, data) {
        var bLeft, bRect, bTop, bottom, cHeight, cWidth, entry, left, mRect, menu, prevEntry, right, style, top, _i, _len, _ref;
        menu = this.makeMenu();
        currentMenu = menu;
  ...
  Settings = {
    ...
    rice: function(section) {
      ...
      _ref = ['time', 'backlink', 'fileInfo', 'favicon', 'usercss'];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        name = _ref[_i];
  ...
  ImageExpand = {
    ...
    cb: {
      ...
      all: function() {
        ...
        $.event('CloseMenu');
        func = (ImageExpand.on = this.checked) ? ImageExpand.expand : ImageExpand.contract;
        _ref = g.posts;
        for (ID in _ref) {
          post = _ref[ID];
