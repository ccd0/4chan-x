...
(function() {
  ...
  Header = {
    ...
    setBarPosition: function(bottom) {
      ...
      if (bottom) {
        ...
        return $.rmClass(Header.nav, 'top');
      } else {
        $.addClass(Header.nav, 'top');
        return $.rmClass(Header.nav, 'bottom');
      }
    },
  ...
  ImageExpand = {
    init: function() {
      ...
      wrapper = $.el('div', {
        id: 'imgControls',
        innerHTML: "<a class='expand-all-shortcut' title='Expand All Images' href='javascript:;'>Expand All Images</a>\n<a class='menu-button' href='javascript:;'>[<i></i>]</a>"
      });
