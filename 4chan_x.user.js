...
(function() {
  ...
  Unread = {
    ...
    update: function() {
      ...
      Favicon.el.href = g.DEAD ? Unread.postsQuotingYou.length ? '//static.4chan.org/image/favicon-status.ico' : count ? Favicon.unreadDead : Favicon.dead : Unread.postsQuotingYou.length ? '//static.4chan.org/image/favicon-status.ico' : count ? Favicon.unread : Favicon["default"];
